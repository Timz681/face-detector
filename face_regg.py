...
st.markdown("<h6 style='text-align: right; color: #FAF8F1'>Built by GoMyCode Pumpkin Redeemers</h6>", unsafe_allow_html=True)

# Load and display image
img = cv2.imread('pngwing.com (1) (1).png')
st.image(img, caption="FACE OF REDEEMERS", width=500)
